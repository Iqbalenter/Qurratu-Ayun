...
<head>
  ...
  <title>Resepsionis | Hotel Harapan</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../template2/index3.html" class="brand-link">
      <img src="../template1/img/logo2.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">HOTEL HARAPAN</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../template1/img/logo2.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Resepsionis Hotel Harapan</h1>
          </div>
          <div class="col-sm-6">
  ...
  if (!empty(@$_GET['page'])){
    switch (@$_GET['page']) {
      case 'reservasi':
        include 'reservasi1.php';
        break;
      default:
        echo "SELAMAT DATANG RESEPSIONIS HOTEL HARAPAN";
        break;
    }
  }
  ?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="index.php">Hotel Harapan</a>.</strong> Hotel Bintang 5 Kesayangan Anda
  </footer>
