...
<body>
    ...
    <main>
        ...
        <div class="row justify-content-center mt-5">
            ...
            ?>
                <section id="detail_kegiatan" class="blog_area section-padding">
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="blog_left_sidebar">
                                    <article class="blog_item">
                                        ...
                                        <div class="blog_details">
                                            <h2 class="blog-head" style="color: #2d2d2d;"><?php echo $row["nama_kegiatan"]; ?></h2>
                                            <p><?php echo $row["ket_kegiatan"]; ?></p>
            ...
            ?>
                <section class="blog_area section-padding p-25">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 mb-5 mb-lg-0">
                                <div class="blog_left_sidebar">
